...
def plotterDET(bgr, lines, paint, centers, normals): #, area_white, area_red, area_yellow):

    bgr = drawLines(bgr, lines, paint, p1_color=(0,255,0), p2_color=(0,0,255))
    # bgr = drawNormals(bgr, lines, normals)
    # bgr = drawNormals2(bgr, centers, normals, paint)
    # bgr = color_segment(area_white, area_red, area_yellow)
    return bgr
